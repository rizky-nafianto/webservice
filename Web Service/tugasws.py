...
#curl -i http://127.0.0.1:7098/addUser -X POST -H 'Content-Type: application/json' -d '{"username":"nim", "password":123}'
...
#curl -i http://127.0.0.1:7098/api/v1/login -X POST -H 'Content-Type: application/json' -d '{"username":"nim", "password": "123"}'
...
#curl -i http://127.0.0.1:7098/api/v2/users/info -X POST -H 'Content-Type: application/json'
